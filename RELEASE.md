...
| :---: | :---: | :---: | :--- |
| `1.21.0` | `40` | 2026-09-07 | Bundled official 'Rust by Example' guided course (24 chapters, 196 interactive lessons); integrated on-demand in-app code execution with terminal output console; migrated playground execution to Cloudflare Workers edge proxy microservice (`https://code-playground.gohk.xyz/`) with edge caching (<50ms) and Bearer auth; maintained 100% offline-first reading core. |
