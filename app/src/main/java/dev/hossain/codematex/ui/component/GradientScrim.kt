...
/**
 * Applies a radial gradient scrim emanating from the top center quarter of the element.
 * Inspired by Google's Jetcaster architecture.
 */
...
/**
 * Draws a vertical gradient scrim in the foreground or background.
 *
 ...
 * @param decay The exponential decay to apply to the gradient. Defaults to `1.0f` (linear)
 * @param numStops The number of color stops to draw in the gradient. Defaults to `16`.
 */
